                            ...
                            <div class="pagetitle">
                                <nav>
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item">Trailer</li>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                ...
                                                <a class="btn btn-success btn-sm mb-2" href="{{ route('trailers.index') }}">
                                            ...
                                            <form action="{{ route('trailers.store') }}" method="POST"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="truck_id" id="truck_id" class="form-control" required>
                                                        ...
                                                        @foreach ($trucks as $truck)
                                                            <option value="{{ $truck->id }}">{{ $truck->truck_number }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <button type="submit" class="btn btn-primary w-100">
                                                    <i class="fa-solid fa-save"></i> Save Trailer
                                                </button>
                                            </form>
                                        </div>
                                    </div>
