            ...
            fetch('/trucks/invite', {
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        if (buttonRef) {
                            const container = buttonRef.closest('.assigned-order'); // find the parent
                            container.find('.assigned-truck').text('None'); // clear truck details
                            buttonRef.hide(); // Hide the invite button
                        }
                    } else {
