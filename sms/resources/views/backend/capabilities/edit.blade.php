                                ...
                                <div class="col-md-11">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            @endif
                                            <form action="{{ route('capabilities.update', $capabilty->id) }}" method="POST"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="status" id="status" class="form-select" required>
                                                        <option value="" disabled
                                                            {{ old('status', $capabilty->status) ? '' : 'selected' }}>
                                                            Select
                                                            Status</option>
                                                        <option value="active"
                                                            {{ old('status', $capabilty->status) == 'active' ? 'selected' : '' }}>
                                                            Active</option>
                                                        <option value="inactive"
                                                            {{ old('status', $capabilty->status) == 'inactive' ? 'selected' : '' }}>
                                                            Inactive</option>
                                                    </select>
                                                </div>
